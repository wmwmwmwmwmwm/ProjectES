...
namespace Naninovel
{
    ...
    public class InputSampler : IInputSampler
    {
        ...
        private readonly Stack<InputInterceptRequest> intercepts = new Stack<InputInterceptRequest>();
        ...
        {
            if (onNextCTS is null) onNextCTS = new CancellationTokenSource();
        ...
        public virtual CancellationToken InterceptNext (CancellationToken token)
        {
            ...
            intercepts.Push(new InputInterceptRequest(cts, token));
            return cts.Token;
        }
