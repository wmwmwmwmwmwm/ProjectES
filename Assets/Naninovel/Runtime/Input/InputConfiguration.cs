    ...
    public class InputConfiguration : Configuration
    {
        ...
        public List<InputBinding> Bindings = new List<InputBinding> {
            ...
            new InputBinding {
                ...
                Axes = new List<InputAxisTrigger> { new InputAxisTrigger { AxisName = "MouseScrollWheel", TriggerMode = InputAxisTriggerMode.Negative } },
            ...
            new InputBinding {
                ...
                Axes = new List<InputAxisTrigger> { new InputAxisTrigger { AxisName = "MouseScrollWheel", TriggerMode = InputAxisTriggerMode.Positive } },
            ...
            new InputBinding {
                ...
                Axes = new List<InputAxisTrigger> {
                    ...
                    new InputAxisTrigger { AxisName = "MouseX", TriggerMode = InputAxisTriggerMode.Both }
                }
            },
            new InputBinding {
                Name = CameraLookY,
                Axes = new List<InputAxisTrigger> {
                    ...
                    new InputAxisTrigger { AxisName = "MouseY", TriggerMode = InputAxisTriggerMode.Both }
                }
            },
            new InputBinding {
                Name = ToggleConsole,
