...
namespace Naninovel.UI
{
    ...
    public class TipsPanel : CustomUI, ITipsUI
    {
        ...
        [Tooltip("Character used to separate title, category and tip text in managed text record.")]
        ...
        private ILocalizationManager l10nManager;
        ...
        public virtual bool HasUnselectedItem ()
        {
            foreach (var item in listItems)
                if (unlockableManager.ItemUnlocked(item.UnlockableId) &&
        ...
        protected override void Awake ()
        {
            ...
            l10nManager = Engine.GetService<ILocalizationManager>();
        ...
        protected override void OnEnable ()
        {
            ...
            l10nManager.OnLocaleChanged += HandleLocaleChanged;
