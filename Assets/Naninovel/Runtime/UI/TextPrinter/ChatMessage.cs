...
namespace Naninovel.UI
{
    ...
    public class ChatMessage : ScriptableUIBehaviour
    {
        ...
        public virtual LocalizableText MessageText
        {
            get => messageText;
            set
            {
                messageText = value;
                onMessageTextChanged?.Invoke(value);
            }
        }
        ...
        public virtual Texture AvatarTexture
        {
            get => avatarImage.texture;
            set
            {
        ...
        private LocalizableText messageText;
