...
namespace Naninovel.UI
{
    ...
    public class RevealableTextPrinterPanel : UITextPrinterPanel, ILocalizableUI
    {
        ...
        public override LocalizableText PrintedText { get => RevealableText.Text; set => RevealableText.Text = value; }
        ...
        public override async UniTask RevealPrintedTextOverTimeAsync (float revealDelay, AsyncToken token)
        {
            ...
            if (revealDelay <= 0) RevealableText.RevealProgress = 1f;
                ...
                while (!await revealer.RevealAsync(revealDelay, token))
        ...
        public override UniTask HandleLocalizationChangedAsync ()
        {
            ...
            async void ForceUpdateRevealState ()
            {
                ...
                RevealPrintedTextOverTimeAsync(0, default).Forget();
            }
        }
