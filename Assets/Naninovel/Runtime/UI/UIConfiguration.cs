...
namespace Naninovel
{
    ...
    public class UIConfiguration : Configuration
    {
        ...
        public ResourceLoaderConfiguration UILoader = new ResourceLoaderConfiguration { PathPrefix = DefaultUIPathPrefix };
        [Tooltip("Configuration of the resource loader used with font resources.")]
        public ResourceLoaderConfiguration FontLoader = new ResourceLoaderConfiguration { PathPrefix = DefaultFontPathPrefix };
        ...
        public Vector2Int[] screenRatios;
        /// <summary>
