...
namespace Naninovel
{
    public class BacklogMessageUI : ScriptableUIBehaviour
    {
        ...
        [SerializeField] private UnityEvent<Color> onMessageColorChanged;
        [SerializeField] private UnityEvent<Color> onAuthorColorChanged;
        ...
        protected virtual void SetAuthor (string authorId)
        {
            ...
            var messageColor = Engine.GetConfiguration<CharactersConfiguration>().GetMetadataOrDefault(authorId).MessageColor;
            var nameColor = Engine.GetConfiguration<CharactersConfiguration>().GetMetadataOrDefault(authorId).NameColor;
            onMessageColorChanged.Invoke(messageColor);
            onAuthorColorChanged.Invoke(nameColor);
        }
