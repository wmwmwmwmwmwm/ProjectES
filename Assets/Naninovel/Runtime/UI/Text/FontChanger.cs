...
namespace Naninovel.UI
{
    public class FontChanger : MonoBehaviour
    {
        ...
        public static void InitializeConfiguration (IUIManager uiManager, IReadOnlyList<CustomUI.FontChangeConfiguration> configuration)
        {
            ...
            for (int i = 0; i < configuration.Count; i++) // Store default fonts and sizes.
            {
                ...
                if (config.IncludeChildren)
                    ...
                    {
                        var font = string.IsNullOrWhiteSpace(uiManager.FontName) ? null : uiManager.GetFontAsset(uiManager.FontName);
                        text.font = font;
        ...
        protected virtual void Awake ()
        {
            ...
            InitializeConfiguration(uiManager, configuration);
        }
