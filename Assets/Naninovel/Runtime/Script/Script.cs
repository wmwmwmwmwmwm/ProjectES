...
namespace Naninovel
{
    ...
    public class Script : ScriptableObject
    {
        ...
        public static Script FromText (string scriptName, string scriptText, string filePath = null)
        {
            ...
            var script = Compiler.ScriptAssetParser.ParseText(scriptName, scriptText, new ParseOptions(logger, false));
        ...
        public static Script FromTransient (string scriptName, string scriptText)
        {
            ...
            var script = Compiler.ScriptAssetParser.ParseText(scriptName, scriptText, new ParseOptions(logger, true));
            ScriptParseErrorLogger.Return(logger);
            return script;
        }
