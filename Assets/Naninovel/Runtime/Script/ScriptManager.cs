...
namespace Naninovel
{
    ...
    public class ScriptManager : IScriptManager
    {
        ...
        public virtual async UniTask InitializeServiceAsync ()
        {
            ...
            foreach (var resource in await scriptLoader.LoadAndHoldAllAsync(this))
                nameToScript[resource.Object.Name] = resource;
            if (Configuration.EnableCommunityModding)
                foreach (var resource in await externalScriptLoader.LoadAndHoldAllAsync(this))
        ...
        public virtual void DestroyService ()
        {
            ...
            externalScriptLoader?.ReleaseAll(this);
        }
