...
namespace Naninovel
{
    ...
    public interface IScriptPlayer : IEngineService<ScriptPlayerConfiguration>
    {
        ...
        /// <summary>
        /// Starts playlist execution at the specified index.
        /// </summary>
        /// <param name="playlist">The playlist to execute.</param>
        /// <param name="playlistIndex">First index inside specified playlist to start from.</param>
        void Play (ScriptPlaylist playlist, int playlistIndex = 0);
        /// <summary>
