...
namespace Naninovel
{
        ...
        where TMeta : ActorMetadata
    {
        ...
        public virtual async UniTask ChangeRotationAsync (Quaternion rotation, float duration, EasingType easingType = default, AsyncToken asyncToken = default)
        {
            ...
            // 기존은 시계방향으로만 회전하는걸 최단 회전방향으로 수정
            Vector3 from = GetBehaviourRotation().eulerAngles;
            Vector3 to = rotation.eulerAngles;
            ...
            var tween = new VectorTween(from, target, duration, SetBehaviourRotation, false, easingType);
        ...
        protected virtual Vector3 GetBehaviourPosition () => Transform.localPosition;
        protected virtual void SetBehaviourPosition (Vector3 position) => Transform.localPosition = position;
