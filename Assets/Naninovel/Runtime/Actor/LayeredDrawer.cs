    ...
    public class LayeredDrawer : IDisposable
    {
        ...
        private void UpdateCanvas ()
        {
            ...
            if (!ObjectUtils.IsPartOfPrefab(transform.gameObject))
                transform.localPosition = new Vector3(0, canvasRect.center.y);
        }
        ...
        private void DrawLayer (LayeredRendererLayer layer, Matrix4x4 rotationMatrix, float pixelsPerUnit)
        {
