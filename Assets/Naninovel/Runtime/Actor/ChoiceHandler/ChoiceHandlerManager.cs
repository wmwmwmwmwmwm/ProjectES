...
namespace Naninovel
{
    ...
    public class ChoiceHandlerManager : ActorManager<IChoiceHandlerActor, ChoiceHandlerState, ChoiceHandlerMetadata, ChoiceHandlersConfiguration>, IChoiceHandlerManager
    {
        ...
        protected virtual Dictionary<PlaybackSpot, PlaybackSpot> PickedChoices { get; } = new Dictionary<PlaybackSpot, PlaybackSpot>();
        ...
        {
            var task = base.LoadServiceStateAsync(stateMap);
