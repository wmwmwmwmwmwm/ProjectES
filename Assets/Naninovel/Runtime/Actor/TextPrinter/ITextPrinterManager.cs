...
namespace Naninovel
{
    ...
    public interface ITextPrinterManager : IActorManager<ITextPrinterActor, TextPrinterState, TextPrinterMetadata, TextPrintersConfiguration>
    {
        ...
        /// <param name="author">Information about character actor to which the printed text belongs (if any).</param>
        ...
        UniTask PrintTextAsync (string printerId, LocalizableText text, AuthorInfo author = default, float speed = 1, AsyncToken asyncToken = default);
    }
}
