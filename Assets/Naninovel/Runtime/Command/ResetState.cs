...
namespace Naninovel.Commands
{
    ...
    {
        /// <summary>
        /// Names of the [engine services](/guide/engine-services) (interfaces) to exclude from reset.
        /// Consider adding `ICustomVariableManager` to preserve the local variables.
        /// </summary>
        [ParameterAlias(NamelessParameterAlias)]
        public StringListParameter Exclude;
        /// <summary>
        /// Names of the [engine services](/guide/engine-services) (interfaces) to reset;
