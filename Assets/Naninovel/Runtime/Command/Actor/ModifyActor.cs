...
namespace Naninovel.Commands
{
        ...
        where TManager : class, IActorManager<TActor, TState, TMeta, TConfig>
    {
        ...
        /// <summary>
        /// Name of the [easing function](/guide/transition-effects#animation-easing) to use for the modification.<br/>
        ...
        public virtual async UniTask PreloadResourcesAsync ()
        {
            ...
            await ActorManager.GetOrAddActorAsync(AssignedId);
            var loader = ActorManager.GetAppearanceLoader(AssignedId);
            if (loader != null) await loader.LoadAndHoldAsync(AssignedAppearance, this);
        }
