...
namespace Naninovel.Commands
{
    ...
    public class AnimateActor : Command
    {
        ...
        /// <summary>
        /// Type of the [transition effect](/guide/transition-effects) to use when animating appearance change (crossfade is used by default).
        /// </summary>
        ...
        /// <summary>
        /// Names of the [easing functions](/guide/transition-effects#animation-easing) to use for the animations.<br/>
