...
//                printer.Author.Id == AssignedAuthorId && !string.IsNullOrEmpty(playedVoicePath))
...
//        {
//            return !metadata.SplitBacklogMessages && !resetText && !printer.Text.IsEmpty && AssignedAuthorId == printer.Author.Id;
//        }
...
//        {
//            var author = CharacterManager.GetAuthorName(authorId) ?? authorId;
...
//        {
//            var info = new AuthorInfo(AssignedAuthorId, AuthorLabel);
//            return PrinterManager.PrintTextAsync(printer.Id, text, info, AssignedRevealSpeed, asyncToken);
//        }
