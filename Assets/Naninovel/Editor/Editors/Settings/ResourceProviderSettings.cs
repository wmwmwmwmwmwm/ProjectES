...
namespace Naninovel
{
    public class ResourceProviderSettings : ConfigurationSettings<ResourceProviderConfiguration>
    {
        ...
        protected override Dictionary<string, Action<SerializedProperty>> OverrideConfigurationDrawers ()
        {
            ...
            drawers[nameof(ResourceProviderConfiguration.LazyPolicySteps)] = p => DrawWhen(Configuration.ResourcePolicy == ResourcePolicy.Lazy, p);
            drawers[nameof(ResourceProviderConfiguration.OptimizeLoadingPriority)] = p => DrawWhen(Configuration.ResourcePolicy == ResourcePolicy.Lazy, p);
