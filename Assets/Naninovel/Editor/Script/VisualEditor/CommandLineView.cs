...
namespace Naninovel
{
    public class CommandLineView : ScriptLineView
    {
            ...
            ErrorCollector errors, VisualElement container, bool hideParameters)
        {
            ...
            ErrorLineView Error (string e) => new ErrorLineView(lineIndex, line.Indent, lineText, container, cmdModel.Identifier, e);

            ParameterFieldData CreateParamFieldData (Metadata.Parameter paramMeta) => new ParameterFieldData {
            ...
            string GetValueFor (Metadata.Parameter m)
            {
                ...
                return Compiler.ScriptSerializer.Serialize(param.Value, new SerializationContext { ParameterValue = true });
            }
        }
