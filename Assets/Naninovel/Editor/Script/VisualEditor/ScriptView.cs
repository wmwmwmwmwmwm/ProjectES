...
namespace Naninovel
{
    public class ScriptView : VisualElement
    {
        ...
        public ScriptLineView CreateLineView (int lineIndex, string lineText)
        {
            ...
            var text = indent > 0 ? lineText.Substring(indent * 4) : lineText;
        ...
        private void OpenHelpFor (ScriptLineView line)
        {
            ...
            switch (line)
            {
                case CommentLineView _:
                    url += "guide/naninovel-scripts#comment-lines";
                    break;
                case LabelLineView _:
                    url += "guide/naninovel-scripts#label-lines";
                    break;
                case GenericTextLineView _:
                    url += "guide/naninovel-scripts#generic-text-lines";
                    break;
