...
namespace Naninovel
{
    [ScriptedImporter(version: 50, ext: "nani")]
    public class ScriptImporter : ScriptedImporter
    {
        ...
        private void IdentifyText (Script script, string contents, string filePath)
        {
            ...
            File.SetLastWriteTime(filePath, time); // Otherwise Unity 2022 warns about file change during import. TODO: Invoke whole method on delay call after import and remove this line.
        }
    }
}
