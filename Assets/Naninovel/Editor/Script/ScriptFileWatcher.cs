...
namespace Naninovel
{
    ...
    public static class ScriptFileWatcher
    {
        ...
        private static readonly ConcurrentQueue<string> modifiedScriptPaths = new ConcurrentQueue<string>();
        private static readonly ConcurrentStack<FileSystemWatcher> runningWatchers = new ConcurrentStack<FileSystemWatcher>();
