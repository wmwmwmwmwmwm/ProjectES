...
namespace Naninovel
{
    public class AboutWindow : EditorWindow
    {
        ...
        public void OnGUI ()
        {
            ...
            if (engineVersion.Final)
            {
                EditorGUILayout.LabelField("WARNING: OUTDATED RELEASE", EditorStyles.boldLabel);
                EditorGUILayout.LabelField("This version is out of support. Register your license to access current stable and preview releases.", EditorStyles.wordWrappedLabel);
                if (GUILayout.Button("Register License")) Application.OpenURL("https://naninovel.com/register");
            }
            else
            {
