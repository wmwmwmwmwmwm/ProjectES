...
namespace VRM
{
	...
	public sealed class UrpVrmMaterialDescriptorGenerator : IMaterialDescriptorGenerator
	{
		...
		//public UtsUnlitMaterialImporter UtsMaterialImporter { get; } = new();
		...
		public MaterialDescriptor Get(GltfData data, int i)
		{
			...
			//if (UtsMaterialImporter.TryCreateParam(data, i, out MaterialDescriptor matDesc)) return matDesc;
		...
		public MaterialDescriptor GetGltfDefault(string materialName = null) => UnlitMaterialImporter.CreateParam(materialName);
	}
}
